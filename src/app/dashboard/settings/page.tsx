    ...
    <Card className="w-4/5 mx-auto">
      ...
      <CardContent>
        <div className="grid gap-4">
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <Select
                  defaultValue={useTheme().resolvedTheme}
                  onValueChange={useTheme().setTheme!}
                >
              ...
              <div>
                ...
                <Select
                  defaultValue={preferredNavMethod}
                  onValueChange={setPreferredNavMethod}
                >
                  <SelectTrigger className="w-full">
          ...
          <div>
            <Button variant="outline" className="justify-start w-85">
              Delete Account
            </Button>
          </div>
        </div>
